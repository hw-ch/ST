...
CREATE TABLE `reply` (
	...
	CONSTRAINT `FK_reply_board` FOREIGN KEY (`bNo`) REFERENCES `board` (`bNo`) ON UPDATE CASCADE ON DELETE CASCADE
)
COLLATE='utf8mb4_0900_ai_ci'
ENGINE=InnoDB
;
...
CREATE TABLE `study` (
	...
	CONSTRAINT `FK_study_category` FOREIGN KEY (`cNo`) REFERENCES `category` (`cNo`) ON UPDATE CASCADE ON DELETE CASCADE
)
COLLATE='utf8mb4_0900_ai_ci'
ENGINE=InnoDB
AUTO_INCREMENT=9
...
CREATE TABLE `studyjoin` (
	...
	CONSTRAINT `FK_studyjoin_study_2` FOREIGN KEY (`sNo`) REFERENCES `study` (`sNo`) ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT `FK_studyjoin_user` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON UPDATE CASCADE ON DELETE CASCADE
)
COLLATE='utf8mb4_0900_ai_ci'
ENGINE=InnoDB
AUTO_INCREMENT=6
...
CREATE TABLE `studyboard` (
	...
	CONSTRAINT `FK_studyboard_study` FOREIGN KEY (`sNo`) REFERENCES `study` (`sNo`) ON UPDATE CASCADE ON DELETE CASCADE
)
COLLATE='utf8mb4_0900_ai_ci'
ENGINE=InnoDB
AUTO_INCREMENT=4
