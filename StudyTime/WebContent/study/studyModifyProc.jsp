...
<%
	...
	if(new StudyDAO().studyUpdate(sTitle, category1, category2, address, recruitCnt, expDate, startDate, sContent, process, sNo)){
		%>
		<!-- Modal -->
		...
		<div class="modal-content">
		  <div class="modal-header">
		    <h1 class="modal-title fs-5" id="exampleModalLabel">스터디 수정</h1>
		    <button onclick = "location.href = '/study/studyView.jsp?sNo=<%=sNo %>'" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		  </div>
